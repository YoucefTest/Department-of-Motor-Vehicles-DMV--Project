...
namespace DVLD.Applications
{
    ...
    public partial class frmAddUpdateLocalDrivingLicesnseApplication: Form
    {
        ...
        {
            //  //this event is responsible for initialize fields with default value   
  ...
  private void _LoadData()
        ...
        {
            // when the form is loads this event handler is triggered . and inside this event  i called 
            _ResetDefualtValues();  // 
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (!this.ValidateChildren())
            {
                ...
                return;
                                                  ...
                                                  //ordinary license class
         int LicenseClassID = clsLicenseClass.Find(cbLicenseClass.Text).LicenseClassID;

   // the system checks if the person already has an active application with
   //the same personID  
   // the same license class, (ordinary driving..)
   // same application type, (new local Driving ..
   // same status ‘New’.
   // If found, it blocks saving to prevent duplicate active applications.” 
      ...
      int ActiveApplicationID =  clsApplication.GetActiveApplicationIDForLicenseClass (ctrlPersonCardWithFilter1.PersonID, clsApplication.enApplicationType.NewDrivingLicense, LicenseClassID);
            ...
            if (ActiveApplicationID != -1) // it means there is another application with same person , license class ,applicationType, status(New)
            {
