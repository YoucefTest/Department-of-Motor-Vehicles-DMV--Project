...
namespace DVLD_Buisness
{
    public  class clsPerson
    {
     ...
     // I used async and await so the UI thread(main thread) doesn’t block or freeze while waiting for the database operation to complete   .
        }
        private async Task <bool> _AddNewPerson()
        {
            //call DataAccess Layer 

            this.PersonID = await clsPersonData.AddNewPerson(
        ...
        private async Task< bool >  _UpdatePerson()
        {
            ...
            return await clsPersonData.UpdatePerson(
        ...
        {
            return await clsPersonData.IsPersonExist(NationlNo);
        }
