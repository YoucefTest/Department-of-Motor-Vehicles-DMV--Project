...
namespace DVLD.People
{
    public partial class frmAddUpdatePerson : Form
    {
        ...
        private void _LoadData()
        {
            ...
            dtpDateOfBirth.Value = _Person.DateOfBirth; //check what is the wrong with this line ,error when i try to update from link above the picture box
        ...
        private async  void txtNationalNo_Validating(object sender, CancelEventArgs e)
        {
            ...
            if (txtNationalNo.Text.Trim() != _Person.NationalNo && await  clsPerson.isPersonExist(txtNationalNo.Text.Trim()))
            {
                e.Cancel = true;
