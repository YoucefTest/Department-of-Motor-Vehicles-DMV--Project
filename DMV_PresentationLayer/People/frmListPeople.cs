...
namespace DVLD.People
{
    public partial class frmListPeople : Form
    {
        ...
        {
           // when the user right click on row in the  dgv and select edit from the context menu this event handler is triggered , inside this event i create instance of frm.. call frm and pass the value in the first column as an argument 
