...
namespace DVLD_DataAccess
{
    public class clsApplicationData
    {
        ...
        public static int GetActiveApplicationIDForLicenseClass(int PersonID, int ApplicationTypeID,int LicenseClassID)
        {
            ...
            SqlConnection connection = new SqlConnection(clsDataAccessSettings.ConnectionString);
            //check if same :  person . ApplicationType(NewLocalDriviing..),licenseClass(oridinary)  ,status(new)
            string query = @"SELECT ActiveApplicationID = Applications.ApplicationID  
                 ...
                 Applications.ApplicationID = LocalDrivingLicenseApplications.ApplicationID
                            ...
                            and ApplicationStatus=1"; //new  , cancel , complete
            //the SQL query already hardcodes ApplicationStatus = 1 directly in the WHERE clause.
